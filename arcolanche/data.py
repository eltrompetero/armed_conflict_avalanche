...
# =================================== #
class ACLED2020():
    fname = (f'{DATADR}/Africa_1997-2022_Dec09-1.csv')
    ...
    @classmethod
    def battles_df(cls, pre_covid=False, to_lower=False):
        """
        Parameters
        ----------
        pre_covid : bool, False
        to_lower : bool, False
    ...
    @classmethod
    def vac_df(cls, pre_covid=False):
        """
        Parameters
        ----------
        pre_covid : bool, False
    ...
    @classmethod
    def riots_and_protests_df(cls, pre_covid=False):
        """
        Parameters
        ----------
        pre_covid : bool, False
